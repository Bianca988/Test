 ...
 */
    ...
    public static double getSmallestDistance(List<? extends Beacon> beaconList, WindowFilter filter) {
        ...
        return (beacon == null) ? Double.MAX_VALUE : beacon.getDistance((RssiFilter) filter);
    ...
    public static Beacon getClosestBeacon(List<? extends Beacon> beaconList, WindowFilter filter) {
        ...
        for (Beacon beacon : beaconList) {
            ...
            float distance = beacon.getDistance((RssiFilter) filter);
    ...
    public static int calculateRssiForDistance(Beacon beacon, float distance) {
        ...
        return calculateRssi(distance, beacon.getCalibratedRssi(), beacon.getCalibratedDistance(), BeaconDistanceCalculation.getPathLossParameter());
    ...
    public static int calculateRssi(float distance, float calibratedRssi, int calibratedDistance, float pathLossParameter) {
        ...
        return calculateRssi(distance, BeaconDistanceCalculation.getCalibratedRssiAtOneMeter(calibratedRssi, calibratedDistance), pathLossParameter);
