...
public class KalmanFilter implements Serializable {
    ...
    /*
        R and Q are constants that can be measured more precisely for each bluetooth tag used
        This is done by running this filter with unit tests and picking the most suitable value
